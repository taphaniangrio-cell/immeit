document.addEventListener('DOMContentLoaded', () => {
  ...
  if (badgeInner && badgeEl) {
    const sentence = window.I18N?.__('hero.badge') || 'IMMEIT — P2M et INDUSTRELEC · Maintenance multi-technique · Installation et maintenance de climatisation | Sénégal & France | Expertise grands comptes : P2M et INDUSTRELEC';
