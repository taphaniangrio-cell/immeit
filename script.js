document.addEventListener('DOMContentLoaded', () => {
  ...
  if (badgeInner && badgeEl) {
    const sentence = window.I18N?.__('hero.badge') || 'IMMEIT – Méthodes Maintenance & Performance Industrielle | Vente, Installation, Mise en Service et Maintenance de Systèmes de Climatisation | Maintenance Multi-technique | Sénégal & France | Expertise grands comptes : P2M et INDUSTRELEC';
