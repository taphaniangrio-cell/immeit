    ...
    '<div class="wrapper">',
      '<div class="container">',
        '<div class="header">',
          ...
          '</div>',
        '</div>',
        '<div class="subject-bar"><h2>', subject, '</h2></div>',
        '<div class="meta">',
          '<div class="meta-flex">',
        ...
        '<div class="footer">',
          ...
          '<a href="mailto:', escapeHtml(msg.email), '?subject=Re%3A%20', encodeURIComponent(msg.subject || ''), '" class="btn-reply">R&eacute;pondre &agrave; ', name, '</a>',
        '</div>',
      '</div>',
    '</div>',
    '</body></html>'
